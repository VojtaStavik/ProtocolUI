//
//  CornerRadiusProtocolTest.swift
//  ProtocolUI
//
...
extension CornerRadius {
    ...
    var pCornerRadius : CGFloat { return CornerRadiusProtocolTest.testValue }
}

class CornerRadiusProtocolTest: XCTestCase {
    
    typealias CurrentTestProtocol           = CornerRadius
    typealias CurrentTestValueType          = CGFloat
    static let testValue : CurrentTestValueType    = 12.345
    ...
    func performTestWithClass(classType : UIView.Type, shouldTestIBDesignable: Bool = false) {
        ...
        XCTAssert(testView.layer.cornerRadius == self.dynamicType.testValue)
    }
