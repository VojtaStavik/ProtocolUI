//
//  BackgroundColorProtocolTest.swift
//  ProtocolUI
//
...
extension BackgroundColor {
    ...
    var pBackgroundColor : UIColor { return BackgroundColorProtocolTest.testValue }
}

class BackgroundColorProtocolTest: XCTestCase {
