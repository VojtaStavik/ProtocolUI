...
class ShouldRasterizeTRUEProtocolTest: XCTestCase {
    
    typealias CurrentTestProtocol           = ShouldRasterizeTRUE
    ...
    func performTestWithClass(classType : UIView.Type, shouldTestIBDesignable: Bool = false) {
        ...
        XCTAssert(testView.layer.shouldRasterize == self.dynamicType.testValue)
    }
