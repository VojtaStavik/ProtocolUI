...
@IBDesignable class MyTextField : UITextField, GreenBackgroundColor { }
...
@IBDesignable class CallToActionTextField : UITextField, WhiteTextColor, BlueBackgroundColor, CallToActionAppearance { }
@IBDesignable class RegularBackgroundView : UIView, GrayBackground { }
...
@IBDesignable class MySmartButton : UIButton, ButtonAppearance, SmartButtonApperance { }
...
@IBDesignable class RedBarButtonItem : UIBarButtonItem, RedTintColor, ButtonFont { }
...
@IBDesignable class MySwitch : UISwitch, MySwitchAppearance { }
@IBDesignable class MyStepper : UIStepper, RedTintColor { }
